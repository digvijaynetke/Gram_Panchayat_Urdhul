...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$stmt = $mysqli->prepare("INSERT INTO achievements (title, description, image) VALUES (?, ?, ?)");
...
if (isset($_GET['delete'])) {
	...
	$mysqli->query("DELETE FROM achievements WHERE id=$id");
	$msg = 'Deleted.';
}
$rows = $mysqli->query("SELECT * FROM achievements ORDER BY id DESC");
?>
<section class="section">
	<div class="container">
		<h2>Manage Awards / Achievements</h2>
		...
		<form method="post" style="margin-bottom:16px;">
			...
			<div class="form-row"><label>Image (path in assets/images/awards)</label><input name="image" placeholder="assets/images/awards/abc.jpg"></div>
